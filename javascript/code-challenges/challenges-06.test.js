...
------------------------------------------------------------------------------------------------ */
const toLastNames = people => { return people.map(person => `${person.firstName} ${person.lastName}`);};
...
const addValues = (arr) => {return arr.reduce((accumulator, currentValue) => accumulator + currentValue, 0);};
...
const addPurchases = (arr) => {return arr.reduce((total, purchase) => total + purchase.purchasePrice, 0);};
...
const countNumberOfElements = (arr) => {return arr.reduce((count) => count + 1, 0);};
