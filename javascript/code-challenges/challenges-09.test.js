...
const appendFirstToLast = (arr) => {
  if (arr.length > 0) {
    ...
    arr.push(firstElement); // Append the first element to the end of the array
  }
};
...
const addBirthYearProperty = (obj, year) => {
  obj.yearBorn = year; // Add a new property 'yearBorn' to the object and assign the 'year' value to it
};
...
const setStatusAsAuthor = (people) => {
  for (let person of people) {
    person.isAuthor = true; // Add a new property 'isAuthor' to each person object and set its value to true
  }
};
/* ------------------------------------------------------------------------------------------------
...
const append = (arr1, arr2) => {
  for (let value of arr2) {
    arr1.push(value); // Append each value from arr2 to arr1
  }
};
