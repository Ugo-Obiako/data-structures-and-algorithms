...
// Proof that the original people array is unchanged
console.log('Original people array:', people);
console.log('New people array:', newPeople);

// Challenge 1 - Create newStuff object
const newStuff = {
  ...stuff,
  cars: [...stuff.cars, 'Honda'] // Adding a new car ('Honda') to the end of the cars array
};

// Create state object using object destructuring assignment
const state = { people, stuff };

// Create newState object
const newState = {
  people: addPeople(people), // Creating newPeople directly within the people node
  stuff: {
    ...stuff,
    cars: [...stuff.cars, 'Ford'] // Adding a new car ('Ford') directly within the stuff node
  }
};

// Proof that the original stuff, state, and people arrays are unchanged
console.log('Original stuff object:', stuff);
console.log('Original state object:', state);
console.log('New stuff object:', newStuff);
